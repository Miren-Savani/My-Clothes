...
const Login = () => {
  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col items-center w-[90%] sm:max-w-96 m-auto mt-14 mb-[400px] gap-4 text-gray-800 '>
      ...
      <button className='bg-black active:bg-gray-700 text-white font-light px-8 py-2 mt-4 rounded-lg'>{currentState==='Login'? 'Sign In':'Sign Up'}</button>
    </form>
  )
}
