...
const Navbar = () => {
  ...
  const { setShowSearch,getCartCount,navigate,token,setToken,setCartItems,setUser } = useContext(ShopContext);
        ...
        <div className='group relative'>
          ...
          <div className='group-hover:block hidden absolute droupdown-menu right-0 pt-4'>
            <div className='flex flex-col gap-2 w-36 py-3 px-5 bg-slate-100 text-gray-500 rounded'>
              ...
              <p onClick={()=>navigate('/orders')} className='cursor-pointer hover:text-black border-t border-gray-300 pt-1'>Orders</p>
              <p onClick={logout} className='cursor-pointer hover:text-black border-t border-gray-300 pt-1'>Logout</p>
            </div>
          </div>
          } 
        </div>
